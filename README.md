...
```
$ git clone https://github.com/albhasan/dotconfig.git
```

Make a backup of the configuration files, for example:
```
$ mv /home/${USER}/.bashrc /home/${USER}.bashrc_backup
```

Then, change to the cloned directory and use GNU stow to create symlinks:
```
$ cd ~/Documents/github/dotconfig
$ stow -t /home/${USER} .
```
...
Autonomy" in [youtube](https://youtu.be/y6XCebnB9gs?si=A-jaTzAPCM_Ta_e2)
